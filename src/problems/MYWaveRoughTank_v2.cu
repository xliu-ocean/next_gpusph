...
MYWaveRoughTank_v2::MYWaveRoughTank_v2(GlobalData *_gdata) : Problem(_gdata)
{
...
void
MYWaveRoughTank_v2::moving_bodies_callback(const uint index, Object* object, const double t0, const double t1,

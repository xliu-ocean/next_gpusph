...
MYWaveRoughTank_v4::MYWaveRoughTank_v4(GlobalData *_gdata) : Problem(_gdata)
{
...
void
MYWaveRoughTank_v4::moving_bodies_callback(const uint index, Object* object, const double t0, const double t1,

...
MYWaveRoughTank_v3::MYWaveRoughTank_v3(GlobalData *_gdata) : Problem(_gdata)
{
...
void
MYWaveRoughTank_v3::moving_bodies_callback(const uint index, Object* object, const double t0, const double t1,

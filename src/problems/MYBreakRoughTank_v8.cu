...
MYBreakRoughTank_v8::MYBreakRoughTank_v8(GlobalData *_gdata) : Problem(_gdata)
{
	...
	//const string dem_file = get_option("dem", "cobble_surface_with_slope_v4_0.1fac.txt");
...
void
MYBreakRoughTank_v8::moving_bodies_callback(const uint index, Object* object, const double t0, const double t1,

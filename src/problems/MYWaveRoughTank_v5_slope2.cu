...
#include "MYWaveRoughTank_v5_slope2.h"
...
MYWaveRoughTank_v5_slope2::MYWaveRoughTank_v5_slope2(GlobalData *_gdata) : Problem(_gdata)
{
...
//		add_flags<ENABLE_PLANES>()
	...
	const float pamp = get_option("paddle_amp", 2.0);
	paddle_amplitude = pamp;
	...
	//m_name = "MYWaveRoughTank_v5_slope2";
...
void
MYWaveRoughTank_v5_slope2::moving_bodies_callback(const uint index, Object* object, const double t0, const double t1,
			...
			KinematicData& kdata, double3& dx, EulerParameters& dr)
{
	...
	//cout << "\npaddle_amplitude: " << paddle_amplitude ;
    }
    else {

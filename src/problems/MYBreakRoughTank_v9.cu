...
MYBreakRoughTank_v9::MYBreakRoughTank_v9(GlobalData *_gdata) : Problem(_gdata)
{
...
void
MYBreakRoughTank_v9::moving_bodies_callback(const uint index, Object* object, const double t0, const double t1,

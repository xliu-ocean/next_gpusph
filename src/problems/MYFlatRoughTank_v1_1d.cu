...
#include "MYFlatRoughTank_v1_1d.h"
...
MYFlatRoughTank_v1_1d::MYFlatRoughTank_v1_1d(GlobalData *_gdata) : Problem(_gdata)
{
...
void
MYFlatRoughTank_v1_1d::moving_bodies_callback(const uint index, Object* object, const double t0, const double t1,

...
MYWaveRoughTank_v5::MYWaveRoughTank_v5(GlobalData *_gdata) : Problem(_gdata)
{
...
void
MYWaveRoughTank_v5::moving_bodies_callback(const uint index, Object* object, const double t0, const double t1,
